...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    paymentMethod: Attribute.Enumeration<['cod', 'online']>;
    deliveryMethod: Attribute.Enumeration<['standard']>;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    genre: Attribute.Enumeration<
      ['Hip Hop', 'Pop', 'City Pop', 'Bossa Nova', 'Alternatives']
    >;
    isSale: Attribute.Boolean;
